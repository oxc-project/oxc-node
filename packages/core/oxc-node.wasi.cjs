// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["Output","OxcTransformer","createResolve","initTracing","load","transform","transformAsync"],"managedRootEntries":["browser.js","index.js","oxc-node.wasm","oxc-node.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve("@oxc-node/core-wasm32-wasi");
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      "@oxc-node/core-wasm32-wasi is installed but is missing oxc-node.wasm32-wasi.wasm.",
    );
  }
