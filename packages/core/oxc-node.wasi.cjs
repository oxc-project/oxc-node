...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('oxc-node-wasm32-wasi')
  } catch {
    throw new Error('Cannot find oxc-node.wasm32-wasi.wasm file, and oxc-node-wasm32-wasi package is not installed.')
  }
}
